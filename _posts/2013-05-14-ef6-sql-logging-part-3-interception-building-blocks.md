...
---
In <a href="http://blog.oneunicorn.com/2013/05/08/ef6-sql-logging-part-1-simple-logging/">parts 1</a> and <a href="http://blog.oneunicorn.com/2013/05/09/ef6-sql-logging-part-2-changing-the-contentformatting/">2</a> of this series we looked at how to use DbContext.Database.Log to log the SQL generated by EF. But this code is actually a relatively thin façade over some low-level building blocks for interception in general and, in this case, DbCommand interception in particular.<!--more-->
